class CreateRunConfigsRunDataAnalysisDataIdentifiers < ActiveRecord::Migration
  def change
    ...
    t.binary  "dataIdentifier",           :limit => 767, :null => false
  end

  add_index "run_run_data_analysis_data_identifiers", ["repository_id", "run_run_data_analysis_id", "dataIdentifier"], :name => "run_run_data_analysis_data_identifiers_index4", :unique => true, :length => {"dataIdentifier" => 767}
