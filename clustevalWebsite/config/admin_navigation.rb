  ...
  navigation.items do |primary|
    ...
    primary.item( :nav_measures, 'Measures', clustering_quality_measures_path) do |sub_measures|
      ...
      @qualityMeasures.each do |clustering_quality_measure|
        sub_measures.item( :nav_measure, clustering_quality_measure.alias, clustering_quality_measure_path(params[:repository], clustering_quality_measure)) do |sub_measure|
         sub_measure.item :nav_measure_general, 'General', clustering_quality_measure_path(params[:repository], clustering_quality_measure)
